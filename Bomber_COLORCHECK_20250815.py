...
import pyxel
BUILD_TAG = 'COLORCHECK-2025-08-15'
BUILD_BG = 10
...
class Game:
    def __init__(self):
        pyxel.init(W, H, title="Bomber-Pyxel [COLORCHECK-2025-08-15]", fps=FPS)
        self.state = TITLE
        self.stage = 1
        self._init_sounds()
        self.reset_stage()
    ...
    def draw_title(self):
        # --- COLOR CHECK BUILD ---
        pyxel.cls(BUILD_BG)  # paint background with a distinctive color
        pyxel.text(2, 2, 'BUILD: COLORCHECK-2025-08-15', 7)
        # --- END COLOR CHECK ---
